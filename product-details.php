                  ...
                  <div class="container">
                        <nav class="py-4 lh-30px" aria-label="breadcrumb">
                              <ol class="breadcrumb justify-content-center py-1 mb-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><?php echo $row["name"]; ?>
                                    </li>
                              </ol>
                        </nav>
                  </div>
      ...
      <!-- <section class="container pt-15 pb-15 pt-lg-17 pb-lg-20">
            ...
            <div class="slick-slider"
                  ...
                  <div class="mb-6">
                        <div class="card card-product grid-2 bg-transparent border-0">
                              <figure class="card-img-top position-relative mb-7 overflow-hidden">
                                    <a href="product-details-v1.php" class="hover-zoom-in d-block"
                                    ...
                                    <div class="position-absolute d-flex z-index-2 product-actions  vertical"><a
                                          ...
                                          <a class="text-body-emphasis bg-body bg-dark-hover text-light-hover rounded-circle square product-action shadow-sm compare"
                                                href="compare.php" data-bs-toggle="tooltip" data-bs-placement="left"
                                                data-bs-title="Compare">
                              ...
                              <div class="card-body text-center p-0">
                                    ...
                                    <h4
                                          ...
                                          <a class="text-decoration-none text-reset"
                                                href="product-details-v1.php">Shield Conditioner</a>
                                    </h4>
                        ...
                        <div class="card card-product grid-2 bg-transparent border-0">
                              ...
                              <div class="card-body text-center p-0">
                                    ...
                                    <h4
                                          class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                          <a class="text-decoration-none text-reset"
                                                href="product-details-v1.php">Perfecting Facial Oil</a>
                                    </h4>
                                    <div class="d-flex align-items-center fs-12px justify-content-center">
                                          <div class="rating">
                                                <div class="empty-stars">
                        ...
                        <div class="card card-product grid-2 bg-transparent border-0">
                              ...
                              <div class="card-body text-center p-0">
                                    ...
                                    <h4
                                          class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                          <a class="text-decoration-none text-reset"
                                                href="product-details-v1.php">Enriched Hand &amp; Body Wash</a>
                                    </h4>
                                    <div class="d-flex align-items-center fs-12px justify-content-center">
                                          <div class="rating">
                                                <div class="empty-stars">
                        ...
                        <div class="card card-product grid-2 bg-transparent border-0">
                              ...
                              <div class="card-body text-center p-0">
                                    ...
                                    <h4
                                          class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                          <a class="text-decoration-none text-reset"
                                                href="product-details-v1.php">Shield Shampoo</a>
                                    </h4>
                                    <div class="d-flex align-items-center fs-12px justify-content-center">
                                          <div class="rating">
                                                <div class="empty-stars">
                        ...
                        <div class="card card-product grid-2 bg-transparent border-0">
                              ...
                              <div class="card-body text-center p-0">
                                    ...
                                    <h4
                                          class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                          <a class="text-decoration-none text-reset"
                                                href="product-details-v1.php">Enriched Hand Wash</a>
                                    </h4>
                                    <div class="d-flex align-items-center fs-12px justify-content-center">
                                          <div class="rating">
                                                <div class="empty-stars">
                  ...
                  <div class="mb-6">
                        <div class="card card-product grid-2 bg-transparent border-0">
                              <figure class="card-img-top position-relative mb-7 overflow-hidden">
                                    <a href="product-details-v1.php" class="hover-zoom-in d-block" title="Enriched Duo">
                              ...
                              <div class="card-body text-center p-0">
                                    ...
                                    <h4
                                          class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                          <a class="text-decoration-none text-reset"
                                                href="product-details-v1.php">Enriched Duo</a>
                                    </h4>
                                    <div class="d-flex align-items-center fs-12px justify-content-center">
                                          <div class="rating">
                                                <div class="empty-stars">
                  ...
                  <div class="mb-6">
                        <div class="card card-product grid-2 bg-transparent border-0">
                              <figure class="card-img-top position-relative mb-7 overflow-hidden">
                                    <a href="product-details-v1.php" class="hover-zoom-in d-block" title="Shield Spray">
                              ...
                              <div class="card-body text-center p-0">
                                    ...
                                    <h4
                                          class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                          <a class="text-decoration-none text-reset"
                                                href="product-details-v1.php">Shield Spray</a>
                                    </h4>
                                    <div class="d-flex align-items-center fs-12px justify-content-center">
                                          <div class="rating">
                                                <div class="empty-stars">
