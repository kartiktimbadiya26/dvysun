...
if (isset($_POST["delete"])) {
      $id = $_POST["delete"];
      $query = "DELETE FROM carousel_data WHERE id=$id";
      ...
      <div class="dashboard-page-content">
            <div class="row mb-9 align-items-center justify-content-between">
                  <div class="col-md-6 mb-8 mb-md-0">
                        <h2 class="fs-4 mb-0">Carousel List</h2>
                  </div>
            </div>
                        ...
                        <div class="table-responsive">
                              <table class="table table-hover align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                          ...
                                          $query = "SELECT * FROM carousel_data LIMIT $limit OFFSET $skip";
                                          $result = mysqli_query($conn, $query);
                                          $temp = 1;
                                          if (isset($_GET["page"])) {
                                                if ($page != 1)
                                                ...
                                                <tr>
                                                      ...
                                                      <td>
                                                            <div class="d-flex align-items-center justify-content-center">
                                                                  <a href="update-carousel.php?id=<?php echo $row["id"]; ?>"
      ...
      <nav aria-label="Page navigation example" class="mt-6 mb-4">
            <ul class="pagination justify-content-start">
                  <li class=" page-item mx-3">
                        <a class="page-link" href="carousel.php?page=<?php
                                                                        if ($page > 1)
                                                                              echo $page - 1;
                                                                        else
                  ...
                  for ($i = 1; $i <= ceil($count / $limit); $i++) {
                        if ($page == $i) { ?>
                              <li class="page-item active mx-3">
                                    <a class="page-link" href="carousel.php?page=<?php echo $i; ?>&limit=<?php echo $limit; ?>">
                                          <?php echo $i; ?>
                                    </a>
                              </li>
                        <?php } else { ?>
