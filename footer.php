...
if (isset($_POST["register"])) {
      ...
      if ($result) {
            ...
            if ($_POST["register"] == "wishlist.php") {
                  header("location:wishlist.php");
            } else {
                  header("location:index.php");
            }
      ...
      <div class="container container-xxl pt-4">
            <div class="row">
                  <div class="col-lg col-md-4 col-12 mb-11 mb-lg-0 fs-14px">
                        ...
                        <p class="pe-xl-18 lh-2">
                              Find a location nearest you. See <a class href="#"><u class="fw-medium">Our
                                          Stores</u></a>
                        </p>
                  ...
                  <div class="col-lg-5 col-12 mb-11 mb-lg-0">
                        ...
                        <p class="lh-2 ">Enter your email below to be the first to know about new collections and
                              product launches.</p>
                        <form class=" pt-8">
            ...
            <div class="row align-items-center mt-0 mt-lg-20 pt-lg-4">
                  ...
                  <div class="col-sm-12 col-md-6 col-lg-4 order-3 text-sm-start text-lg-end mt-8 mt-lg-0">
                        <img src="#" data-src="./assets/images/footer/img_1.png" width="313" height="28" alt="Paypal"
...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
      ...
      <symbol id="icon-logout" viewBox="0 0 32 32">
            <path
                  d="M12 4h8c2.21 0 4 1.79 4 4v4h-2V8c0-1.1-.9-2-2-2h-8c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2v-4h2v4c0 2.21-1.79 4-4 4h-8c-2.21 0-4-1.79-4-4V8c0-2.21 1.79-4 4-4z" />
            <path d="M21 16l-4-4v3H9v2h8v3z" />
      </symbol>
      <!-- <symbol id="icon-logout" viewBox="0 0 32 32">
            <path
      ...
      <symbol id="icon-f2" viewBox="0 0 32 32">
            <path d="M29.867 31.963h-28.196v-4.488h28.196v4.488zM2.563 31.072h26.413v-2.705h-26.413v2.705z">
            </path>
            <path d="M26.943 28.367h-22.348v-2.66h22.348v2.66zM5.487 27.475h20.565v-0.877h-20.565v0.877z"></path>
            <path d="M11.022 26.609h-4.475v-17.882h4.475v17.882zM7.438 25.718h2.692v-16.099h-2.692v16.099z">
            </path>
      ...
      <svg id="moon-stars" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 21" stroke="currentColor" stroke-width="2"
      ...
      <div class="container-wide container-xxl">
            <nav class="navbar navbar-expand-xl px-0 py-6 py-xl-12 row align-items-start">
                  <div class="col-xl-3 d-flex justify-content-center justify-content-xl-start">
                        <a href="index.php" class="navbar-brand py-4 d-lg-inline-block">
                        ...
                        <form class="w-xl-100 w-sm-75 w-100 mt-6 mt-xl-0 px-6 px-xl-0">
                              <div class="input-group mx-auto">
                                    ...
                                    <div
                                          ...
                                          <button class="input-group-text bg-transparent border-0 px-0 me-6"
                                                type="submit">
            ...
            <div class="modal-content">
                  ...
                  <div class="modal-body px-sm-13 px-8">
                        <p class="text-center fs-16 mb-10">Don’t have an account yet? <a href="#" data-bs-toggle="modal"
                                    data-bs-target="#signUpModal" class="text-black">Sign
                                    up</a> for free</p>
                        <form method="post">
                              ...
                              <button type="submit" name="login" value="Login"
                                    class="btn btn-dark btn-hover-bg-primary btn-hover-border-primary w-100">Log
                                    In</button>
                              <div class="d-flex align-items-center justify-content-between mt-8 mb-7">
                              </div>
                        </form>
            ...
            <div class="modal-content">
                  ...
                  <div class="modal-body px-sm-13 px-8">
                        <p class="text-center fs-16 mb-10">Already have an account? <a href="#" data-bs-toggle="modal"
                                    data-bs-target="#signInModal" class="text-black">Log
                                    in</a></p>
                        <form method="post">
                              <input name="firstname" type="text" class="form-control border-1 mb-5"
                                    placeholder="First name" required>
                              <input name="lastname" type="text" class="form-control border-1 mb-5"
                              ...
                              <button type="submit" value="Sign Up" name="register"
                                    class="btn btn-dark btn-hover-bg-primary btn-hover-border-primary w-100">Sign
                                    Up</button>
                              <div class="d-flex align-items-center justify-content-between mt-8 mb-7">
                              </div>
                        </form>
                        ...
                        <div class="row ">
                              <div class="col-md-6 pe-13">
                                    <div class="position-relative">
                                          ...
                                          <div id="slider"
                                                ...
                                                <a href="assets/images/shop/product-gallery-05.jpg"
                                                      data-gallery="gallery1"
                                                      data-thumb-src="assets/images/shop/product-gallery-05.jpg"><img
                                                            src="#"
                                                            data-src="./assets/images/shop/product-gallery-05.jpg"
                                                            class="h-auto lazy-image" width="540" height="720" alt></a>
                                                <a href="assets/images/shop/product-gallery-06.jpg"
                                                      data-gallery="gallery1"
                                                      data-thumb-src="assets/images/shop/product-gallery-06.jpg"><img
                                                            src="#"
                                                            data-src="./assets/images/shop/product-gallery-06.jpg"
                                                            class="h-auto lazy-image" width="540" height="720" alt></a>
                                                <a href="assets/images/shop/product-gallery-07.jpg"
                                                      data-gallery="gallery1"
                                                      data-thumb-src="assets/images/shop/product-gallery-07.jpg"><img
                                                            src="#"
                                                            data-src="./assets/images/shop/product-gallery-07.jpg"
                                                            class="h-auto lazy-image" width="540" height="720" alt></a>
                                                <a href="assets/images/shop/product-gallery-08.jpg"
                                                      data-gallery="gallery1"
                                                      data-thumb-src="assets/images/shop/product-gallery-08.jpg"><img
                                                            src="#"
                              ...
                              <div class="col-md-6 pt-md-0 pt-10">
                                    ...
                                    <h1 class="mb-4 pb-2 fs-4">
                                          <a href="shop/product-details-v1.php" title="Natural Coconut Cleansing Oil">
                                    ...
                                    <p class="fs-15px">Niacinamide and Vitamin C are two anti-aging superstars but
                                          not usually formulated together because of their different pH levels.
                                    </p>
                                    <p class="mb-4 pb-2">
                                    ...
                                    <div class="card border-0 bg-body-tertiary rounded text-center mt-7">
                                          ...
                                          <div class="card-body pt-6 pb-7">
                                                <p class="fs-14px fw-normal mb-0">Guarantee safe &amp; secure
                                                      checkout</p>
                                          </div>
                                    </div>
                  ...
                  <ul class="navbar-nav">
                        <li class="nav-item transition-all-xl-1 py-0 dropdown dropdown-fullwidth">
                              <a class="nav-link d-flex justify-content-between position-relative text-uppercase fw-semibold ls-1 fs-15px dropdown-toggle"
                                    href="index-2.php" data-bs-toggle="dropdown" id="menu-item-home-canvas"
                                                            ...
                                                            <li>
                                                                  <a href="home-01.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Home
                                                                              01</span></a>
                                                            </li>
                                                            <li>
                                                                  <a href="home-02.php"
                        ...
                        <li class="nav-item transition-all-xl-1 py-0 dropdown dropdown-fullwidth position-static">
                              <a class="nav-link d-flex justify-content-between position-relative text-uppercase fw-semibold ls-1 fs-15px dropdown-toggle"
                                    href="store.php" data-bs-toggle="dropdown" id="menu-item-shop-canvas"
                                          ...
                                          <div class="row">
                                                <div class="col">
                                                      ...
                                                      <ul class="list-unstyled mb-0">
                                                            <li>
                                                                  <a href="shop/shop-layout-v1.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Shop
                                                                              Layout <sup>v1</sup></span></a>
                                                            </li>
                                                            <li>
                                                                  <a href="shop/shop-layout-v2.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Shop
                                                                              Layout <sup>v2</sup></span></a>
                                                            </li>
                                                            <li>
                                                                  <a href="shop/shop-layout-v3.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Shop
                                                                              Layout <sup>v3</sup></span></a>
                                                            </li>
                                                            <li>
                                                                  <a href="shop/shop-layout-v4.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Shop
                                                                              Layout <sup>v4</sup></span></a>
                                                            </li>
                                                            <li>
                                                                  <a href="shop/shop-layout-v5.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Shop
                                                                              Layout <sup>v5</sup></span></a>
                                                            </li>
                                                      </ul>
                                                </div>
                                                <div class="col">
                                                      ...
                                                      <ul class="list-unstyled mb-0">
                                                            <li>
                                                                  <a href="shop/product-details-v1.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Product
                                                                              Detail <sup>v1</sup></span></a>
                                                            </li>
                                                            <li>
                                                                  <a href="shop/product-details-v2.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Product
                                                                              Detail <sup>v2</sup></span></a>
                                                            </li>
                                                            <li>
                                                                  <a href="shop/product-details-v3.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Product
                                                                              Detail <sup>v3</sup></span></a>
                                                            </li>
                                                            <li>
                                                                  <a href="shop/product-details-v4.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Product
                                                                              Detail <sup>v4</sup></span></a>
                                                            </li>
                                                            <li>
                                                                  <a href="shop/product-details-v5.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Product
                                                                              Detail <sup>v5</sup></span></a>
                                                            </li>
                                                            <li>
                                                                  <a href="shop/product-details-v6.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Product
                                                                              Detail <sup>v6</sup></span></a>
                                                            </li>
                                                            <li>
                                                                  <a href="shop/product-details-v7.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Product
                                                                              Detail <sup>v7</sup></span></a>
                                                            </li>
                                                            <li>
                                                                  <a href="shop/product-details-v8.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Product
                                                                              Detail <sup>v8</sup></span></a>
                                                            </li>
                                                      </ul>
                                                </div>
                                                <div class="col">
                                                      ...
                                                      <ul class="list-unstyled mb-0">
                                                            <li>
                                                                  <a href="shop/product-simple.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Product
                                                                              Simple</span></a>
                                                            </li>
                                                            <li>
                                                                  <a href="shop/product-variable.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Product
                                                                              Variable</span></a>
                                                            </li>
                                                            <li>
                                                                  <a href="shop/product-time-limit.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Product
                                                                              Time Limit</span></a>
                                                            </li>
                                                            <li>
                                                                  <a href="shop/product-grouped.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Product
                                                                              Grouped</span></a>
                                                            </li>
                                                ...
                                                <div class="col d-xxl-block d-none megamenu-shop-banner"
                                                      ...
                                                      <div class="card border-0 mt-4">
                                                            ...
                                                            <div
                                                                  ...
                                                                  <div class="mt-auto">
                                                                        <a href="#" class="btn btn-white">Shop
                                                                              Sale</a>
                                                                  </div>
                                                            </div>
                                                      </div>
                              ...
                              <ul class="dropdown-menu py-6" aria-labelledby="menu-item-pages-canvas">
                                    <li class="dropend" aria-haspopup="true" aria-expanded="false">
                                          ...
                                          <ul class="dropdown-menu py-6" aria-labelledby="menu-item-blog-canvas"
                                                data-bs-popper="none">
                                                <li>
                                                      <a class="dropdown-item border-hover" href="blog/grid.php">
                                                            <span class="border-hover-target">Blog Grid</span>
                                                      </a>
                                                </li>
                                                <li>
                                                      <a class="dropdown-item border-hover"
                                                            href="blog/grid-sidebar.php">
                                                            <span class="border-hover-target">Blog Grid
                                                                  Sidebar</span>
                                                      </a>
                                                </li>
                                                <li>
                                                      <a class="dropdown-item border-hover" href="blog/masonry.php">
                                                            <span class="border-hover-target">Blog Masonry</span>
                                                      </a>
                                                </li>
                                                <li>
                                                      <a class="dropdown-item border-hover" href="blog/list.php">
                                                            <span class="border-hover-target">Blog List</span>
                                                      </a>
                                                </li>
                                                <li>
                                                      <a class="dropdown-item border-hover" href="blog/classic.php">
                                                            <span class="border-hover-target">Blog Classic</span>
                                                      </a>
                                                </li>
                                                <li class="dropdown-divider"></li>
                                                <li>
                                                      <a class="dropdown-item border-hover" href="blog/details-01.php">
                                                            <span class="border-hover-target">Blog Details
                                                                  01</span>
                                                      </a>
                                                </li>
                                                <li>
                                                      <a class="dropdown-item border-hover" href="blog/details-02.php">
                                                            <span class="border-hover-target">Blog Details
                                                                  02</span>
                                                      </a>
                                                </li>
                                    ...
                                    <li class="dropend" aria-haspopup="true" aria-expanded="false">
                                          ...
                                          <ul class="dropdown-menu py-6" aria-labelledby="menu-item-about-us-canvas"
                                                data-bs-popper="none">
                                                <li>
                                                      <a class="dropdown-item border-hover" href="about-us-01.php">
                                                            <span class="border-hover-target">About Us 01</span>
                                                      </a>
                                                </li>
                                                <li>
                                                      <a class="dropdown-item border-hover" href="about-us-02.php">
                                    ...
                                    <li class="dropend" aria-haspopup="true" aria-expanded="false">
                                          ...
                                          <ul class="dropdown-menu py-6" aria-labelledby="menu-item-contact-us-canvas"
                                                data-bs-popper="none">
                                                <li>
                                                      <a class="dropdown-item border-hover" href="contact-us-01.php">
                                                            <span class="border-hover-target">Contact Us 01</span>
                                                      </a>
                                                </li>
                                                <li>
                                                      <a class="dropdown-item border-hover" href="contact-us-02.php">
                                    ...
                                    <li class="dropend" aria-haspopup="true" aria-expanded="false">
                                          <a class="dropdown-item pe-6 dropdown-toggle d-flex justify-content-between border-hover"
                                                href="dashboard/dashboard.php" data-bs-toggle="dropdown"
                                    ...
                                    <li>
                                          <a class="dropdown-item pe-6 border-hover" href="faqs.php">
                                                <span class="border-hover-target">
                                                      FAQs
                                                </span>
                                          </a>
                                    ...
                                    <li>
                                          <a class="dropdown-item pe-6 border-hover" href="find-a-store.php">
                                                <span class="border-hover-target">
                                                      Store
                                                </span>
                                          </a>
                                    ...
                                    <li>
                                          <a class="dropdown-item pe-6 border-hover" href="404.php">
                                                <span class="border-hover-target">
                                                      404
                                                </span>
                                          </a>
                        ...
                        <li class="nav-item transition-all-xl-1 py-0 dropdown dropdown-fullwidth">
                              ...
                              <div class="dropdown-menu mega-menu start-0 py-6 "
                                    aria-labelledby="menu-item-blocks-canvas" style="width:800px">
                                    <div class="megamenu-home container py-8 px-12">
                                          <div class="row">
                                                <div class="col">
                                                      <h6 class="fs-18px">Group 1</h6>
                                                      <ul class="list-unstyled">
                                                            <li>
                                                                  <a href="blocks/blog.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Blog</span></a>
                                                            </li>
                                                            <li>
                                                                  <a href="blocks/banner.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Banner</span></a>
                                                            </li>
                                                            <li>
                                                                  <a href="blocks/call-to-action.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Call To
                                                                              Action</span></a>
                                                            </li>
                                                            <li>
                                                                  <a href="blocks/hero.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                ...
                                                <div class="col">
                                                      ...
                                                      <ul class="list-unstyled">
                                                            <li>
                                                                  <a href="blocks/products.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Products</span></a>
                                                            </li>
                                                            <li>
                                                                  <a href="blocks/products-slide.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Products
                                                                              Slide</span></a>
                                                            </li>
                                                            <li>
                                                                  <a href="blocks/product-tabs.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">Product
                                                                              Tabs</span></a>
                                                            </li>
                                                            <li>
                                                                  <a href="blocks/news-letter.php"
                                                                        class="border-hover text-decoration-none py-3 d-block"><span
                                                                              class="border-hover-target">News
                                                                              Letter</span></a>
                                                            </li>
                                                      </ul>
                                                </div>
                        ...
                        <li class="nav-item transition-all-xl-1 py-0 dropdown dropdown-fullwidth">
                              ...
                              <div class="dropdown-menu mega-menu start-0 py-6 "
                                    ...
                                    <div class="menumega-docs px-8" style="min-width: 250px">
                                          <a href="docs/usage/getting-started.php"
                                          ...
                                          <a href="docs/components/accordion.php"
                                          ...
                                          <hr class="dropdown-divider mx-n8" />
                                          <a href="docs/usage/changelog.php"
