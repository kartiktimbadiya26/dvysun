...
if (isset($_POST["good_email"])) {
      $email = $_POST['email'];

      if ($email !== "" && $email !== " ") {
            $query = "INSERT INTO good_emails (email)
          SELECT '$email'
          FROM dual
          WHERE NOT EXISTS (
            SELECT 1
      ...
      <div class="container container-xxl pt-4">
            <div class="row">
                  <div class="col-lg col-md-4 col-12 mb-11 mb-lg-0 fs-14px">
                        ...
                        <p class="mb-0 lh-2"><strong class="text-body-emphasis">+91 98751 03176</strong>
                              <br>
                              cdmikartiktimbadiya@gmail.com
                        </p>
                  </div>
                  <div class="col-lg col-md-4 col-12 mb-11 mb-lg-0">
                        ...
                        <ul class="list-unstyled mb-0 fw-medium ">
                              ...
                              <li class="pt-3 mb-4">
                                    <a href="faq.php" title="Shipping FAQ" class="text-body">Shipping FAQ</a>
                              </li>
                              <li class="pt-3 mb-4">
                                    <a href="terms.php" title="Terms &amp; Conditions" class="text-body">Terms &amp;
                                          Conditions</a>
                              </li>
                              <li class="pt-3 mb-4">
                                    <a href="privacy.php" title="Privacy Policy" class="text-body">Privacy Policy</a>
                              </li>
                        </ul>
                  </div>
                        ...
                        <form class="pt-8" method="post">
                              <div class="input-group position-relative">
                                    <input type="email" class="form-control bg-body rounded-left"
                                          placeholder="Enter your email address" name="email" require>
                                    <button type="submit" name="good_email"
            ...
            <div class="row align-items-center mt-0 mt-lg-20 pt-lg-4">
                  <div
                        ...
                        <p class="mb-0">
                              ...
                              © DVYSUN - <a href="">Beauty</a> & Cosmetics Shop.
                        </p>
                  </div>
                  <div class="col-sm-12 col-lg-4 text-md-center order-1 order-lg-2 ">
                        <a class="d-inline-block text-decoration-none" href="index.php">
                              <h2>DVYSUN</h2>
                        </a>
                  </div>
...
<script>
      $(document).ready(function() {
            $('.quick-view').on('click', function(e) {
                  ...
                  $.ajax({
                        url: 'fetch_product.php', // PHP file to fetch product details
                        type: 'GET',
                        data: {
                              id: productId
                        },
                        success: function(data) {
                              // Populate the modal with fetched product data
                              console.log(data);
      ...
      <div class="container-wide container-xxl">
            <nav class="navbar navbar-expand-xl px-0 py-6 py-xl-12 row align-items-start">
                  ...
                  <div class="col-xl-6 d-flex justify-content-center">
                        <form class="w-xl-100 w-sm-75 w-100 mt-6 mt-xl-0 px-6 px-xl-0" action="grid-layout.php" method="get">
                              <div class="input-group mx-auto">
                                    <input type="text" name="search" class="form-control form-control bg-transparent border-primary"
            ...
            <div class="offcanvas-body pt-0 mb-2">
                  <ul class="navbar-nav">
                        <li class="nav-item transition-all-xl-1 py-0 dropdown dropdown-fullwidth">
                              <a class="nav-link d-flex justify-content-between position-relative text-uppercase fw-semibold ls-1 fs-15px dropdown-toggle" href="index.php" id="menu-item-home-canvas">Home</a>
                        </li>
                        <li class="nav-item transition-all-xl-1 py-0 dropdown dropdown-fullwidth">
                              <a class="nav-link d-flex justify-content-between position-relative text-uppercase fw-semibold ls-1 fs-15px dropdown-toggle" href="grid-layout.php" id="menu-item-home-canvas">Shop</a>
                        </li>
                        <li class="nav-item transition-all-xl-1 py-0 dropdown dropdown-fullwidth">
                              <a class="nav-link d-flex justify-content-between position-relative text-uppercase fw-semibold ls-1 fs-15px dropdown-toggle" href="blog.php" id="menu-item-home-canvas">Blog</a>
                        </li>
                        <li class="nav-item transition-all-xl-1 py-0 dropdown dropdown-fullwidth">
                              <a class="nav-link d-flex justify-content-between position-relative text-uppercase fw-semibold ls-1 fs-15px dropdown-toggle" href="contact-us.php" id="menu-item-home-canvas">Contact US</a>
                        </li>
                  </ul>
            </div>
            <hr class="mb-0">
